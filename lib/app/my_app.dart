...
class MyApp extends ConsumerWidget {
    ...
    "checkout": {
      ...
      "fallback": {
        ...
        "flightDetails": {
          ...
          "subtitle": "Let your car supplier know when and where to expect you, especially if your flight is delayed.",
          "icon": "plane",
          "fields": [
            {
              "id": "departureDate",
          ...
          "options": [
            ...
            },
            {
              ...
              "calculation": {
                ...
                "breakdownIconClasses": [
                  "text-success"
                ],
                "breakdownTitleClasses": [
                  "text-body",
                  "text-sm",
                  "font-bold"
                ],
                "breakdownLabelClasses": [
                  "text-muted",
                  "text-xs"
                ],
                "breakdownValueClasses": [
                  "text-body",
                  "text-xs",
                  "font-bold"
                ],
          ...
          "options": [
            ...
            },
            {
              ...
              "calculation": {
                ...
                "address": "45 Oxford Street, London W1D 2DZ",
                "buttonLabel": "Calculate Distance",
                "successMessage": "Collection distance calculated successfully.",
                "breakdownIcon": "truck",
        ...
        "protectionPackage": {
          ...
          "description": "Without protection, up to the full vehicle value will be charged in case of damage or theft.",
          "options": [
            {
              ...
              "coverageText": "You remain responsible for repair or replacement costs up to the full value of the vehicle for damage, loss, or theft."
            },
            {
              "id": "cover_the_car",
              "title": "Cover The Car",
        ...
        "securityDeposit": {
          ...
          "description": "A refundable security deposit of £250 is required for this booking. The deposit will be returned within 7 days after the rental period.",
          "icon": "security"
        },
      "qdrivePass": {
  "title": "Qdrive Pass",
  "subtitle": "Skip the £250 deposit — choose a plan below",
  "options": [
    {
      "id": "skip_deposit_with_qdrive_pass",
      "title": "Skip the Deposit with QDrive Pass",
      "description": "Purchase any QDrive Pass membership and avoid paying the security deposit. Plus, get included rental days and exclusive benefits!",
      "icon": "crown",
      "plans": [
        {
          "id": "standard_pass",
        ...
        "priceDetails": {
          "title": "Price details",
          "subtitle": "Summary by step and line-item amounts. Total includes tax.",
          "summary": [
            {
              "title": "Dates",
              "value": "2026-04-20 → 2026-04-25 • 5 days"
            },
            {
              "title": "Pickup / Drop-off",
              "value": "Pickup at supplier location\nReturn at supplier location"
            },
            {
              "title": "Mileage",
              "value": "600 miles"
            ...
            {
              "title": "Protection package",
              "value": "No add-on cover"
            },
            {
              "title": "Extras",
              "value": "Child seat ×1 · GPS ×2 · Additional driver ×1 · WiFi ×1"
            },
            {
              "title": "Qdrive Pass",
              "value": "Standard Pass"
  ...
  "actions": {
    ...
    "openPriceDetails": {
      ...
      "params": {
        "bind": "dynamicData.checkout.priceDetails"
      }
    },
    "openChat": {
      "type": "open_chat",
                                          ...
                                          "children": [
                                            {
                                              ...
                                              "themeKey": "badge",
                                              "size": "sm",
                                              "visibleWhen": "option.badgeIcon != null"
                                            },
                                            {
                                              "type": "text",
                                              "key": "option.badge",
                                  ...
                                  },
                                  {
                                    ...
                                    "children": [
                                      ...
                                      },
                                      {
                                        ...
                                        "visibleWhen": "option.linkLabel != null"
                                      },
                                      {
                                      ...
                                      },
                                      {
                                        ...
                                        "visibleWhen": "option.expanded == true",
                                        "children": [
                                          {
                                            "type": "text",
                                            "key": "option.coverageText",
                                            "themeKey": "optionText",
                                            "visibleWhen": "option.coverageText != null"
                                          },
                                          {
                                            "type": "for_each",
                                            "itemsKey": "option.coverageItemsBulleted",
                                            "itemName": "coverage",
                                            "layout": "column",
                                            "classes": [
                                              "mt-sm"
                                            ],
                                            "visibleWhen": "option.coverageItemsBulleted != null",
                                            "child": {
                                              "type": "text",
                                              "key": "coverage",
                                              "themeKey": "optionText",
                      ...
                      "child": {
                        ...
                        "child": {
                          ...
                          "children": [
                            {
                              "type": "text",
                              "key": "plan.coverage.billingNote",
                              "themeKey": "mutedFeatureText"
                            },
                            {
                              "type": "for_each",
                              "itemsKey": "plan.coverage.features",
                              "itemName": "feature",
                              "layout": "column",
                              "classes": [
                                "mt-sm"
                            ...
                            {
                              "type": "text",
                              "key": "plan.coverage.bestForLabel",
                              "themeKey": "mutedFeatureText",
                              "classes": [
                                "mt-sm"
                              ]
